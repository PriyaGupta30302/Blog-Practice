...
import '../../../components/editor-styles.css'; // Adjust path if needed, should be same as used in editor

// Optional: for ISR/SWR
...
export default async function PostDetailPage(props) {
  ...
  return (
    <div className="min-h-screen">
      <article className="max-w-[1340px] mx-auto px-4 py-12">
        <Link
          href="/"
        ...
        <div className="p-8 md:p-12">
          ...
          {/* Main Blog Content - styled with TipTap/ProseMirror classes */}
          <div
            className="ProseMirror prose prose-lg max-w-none mb-8"
